    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        <div class="head-container">
          <el-input v-model="deptName" placeholder="请输入查询的名称" clearable size="small" prefix-icon="el-icon-search" style="margin-bottom: 20px" />
        </div>
...
<!--          </el-col>-->
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <!-- <el-table-column label="岗位" align="center" prop="nickName" :show-overflow-tooltip="true" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="960px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="职责" prop="pduty">
              <el-input v-model="form.pduty" placeholder="请输入职责"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item  label="身份证号" prop="pcode">
              <el-input v-model="form.pcode" placeholder="请输入用户身份证号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
         ...
         <el-row>
          <el-col :span="12">
            <el-form-item label="年龄" prop="ages">
              <el-input v-model="form.ages" placeholder="请输入用户年龄" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="学历" prop="pedu">
              <el-input v-model="form.pedu" placeholder="请输入用户学历"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
